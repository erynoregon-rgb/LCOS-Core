...
- External pull requests are not being accepted by default.
- If collaboration is desired, open an issue describing the proposed change.
- The maintainer may choose to accept targeted changes later.
